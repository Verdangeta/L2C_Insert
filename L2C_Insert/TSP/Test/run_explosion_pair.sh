...
# Thin wrapper around run_explosion_experiments.py.
# Keeps compatibility with the old entrypoint while delegating baseline caching,
# sweeps, and pair analysis orchestration to Python.
...
python -u "$SCRIPT_DIR/run_explosion_experiments.py" \
